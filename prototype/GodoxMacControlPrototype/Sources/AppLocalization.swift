...
private struct RuntimeMessageTemplate {
    ...
    static let all: [RuntimeMessageTemplate] = [
        ...
        .init(source: "Hay una escena anterior por recuperar ({value}); conecta el radio original antes de continuar", localizationKey: "runtime.controller.previousSceneRecovery"),
        ...
        .init(source: "Multi se ajustó al rango común {value}", localizationKey: "runtime.controller.multiNormalized"),
        .init(source: "Multi limitó la secuencia a {value} destellos para la potencia, Hz y modelos participantes", localizationKey: "runtime.controller.multiCountLimited"),
        .init(source: "El grupo {value} no admite Multi en este perfil", localizationKey: "runtime.controller.multiUnsupportedGroup"),
        .init(source: "Multi global se activó en los grupos {value}", localizationKey: "runtime.controller.multiGroupsActivated"),
        .init(source: "Multi es global; se apagaron los grupos {value}", localizationKey: "runtime.controller.multiGroupsDisabled"),
        .init(source: "Multi global se desactivó; se restauró la escena previa en {value}", localizationKey: "runtime.controller.multiExitedRestored"),
        .init(source: "No se pudo restaurar la escena previa de {value}", localizationKey: "runtime.controller.multiRestoreFailed"),
        .init(source: "La configuración de {value} actualizó su rango de potencia", localizationKey: "runtime.controller.rangeUpdated"),
        .init(source: "Ajuste seguro preparado para recuperar {value}; falta pulsar Aplicar", localizationKey: "runtime.controller.recoveryPrepared"),
        .init(source: "Escena segura preparada para recuperar {value}; falta pulsar Aplicar", localizationKey: "runtime.controller.recoveryScenePrepared"),
